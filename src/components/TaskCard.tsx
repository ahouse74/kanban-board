...
import { Calendar, MessageSquare, Trash2, AlertTriangle, Clock } from 'lucide-react'
...
export function TaskCard({ task, isDragging = false, onOpen, onDelete }: Props) {
  ...
  return (
    <div
      ...
      onClick={() => onOpen(task)}
      className={`
        group relative bg-[#1a1a26] border border-white/[0.07] rounded-xl p-3.5
